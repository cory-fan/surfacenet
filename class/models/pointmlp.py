...
class Model(nn.Module):
    def __init__(self, points=1024, class_num=2, embed_dim=64, groups=1, res_expansion=1.0,
...
def pointMLP(num_classes=2, **kwargs) -> Model:
    return Model(points=600, class_num=num_classes, embed_dim=64, groups=1, res_expansion=1.0,
                   activation="relu", bias=False, use_xyz=False, normalize="anchor",
                   dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
                   k_neighbors=[24, 24, 24, 24], reducers=[2, 2, 2, 2], **kwargs)


def pointMLPElite(num_classes=2, **kwargs) -> Model:
