...
def load_data(partition, fpath='modelnet40_ply_hdf5_2048'):
    if (fpath=='modelnet40_ply_hdf5_2048'):
        download()
    BASE_DIR = os.path.dirname(os.path.abspath(__file__))
    DATA_DIR = os.path.join(BASE_DIR, 'data')
    all_data = []
...
class KumamotoEQ(Dataset):
    def __init__(self, num_points, partition='train'):
        print("Kumamoto dataset")
        self.data, self.label = load_data(partition,fpath='kumamoto')
