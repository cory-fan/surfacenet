...
def parse_args():
    ...
    parser.add_argument('--test_path', default='./data/kumamoto/test', help='path of the test data')
    parser.add_argument('--checkpoint', default='log/classification/2024-04-05_00-55/checkpoints/best_model.pth', help='path of the checkpoint')
...
def main(args):
    ...
    testDataLoader = DataLoader(TEST_DATASET, batch_size=32, shuffle=False, num_workers=0)
