...
class DownSampler(nn.Module):
    ...
    def forward(self,xyz,x):
        idx = farthest_point_sample(xyz,self.out_points)
...
class DSNet(nn.Module):
    ...
    def __init__(self,num_classes=3,points=600,embedding_channel=150,blocks=[2,6,2],down_factor=[2,2,2],up_blocks=[1,1,1]):
        super().__init__()
